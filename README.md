...
- Automatically create and update the _Moodfade_ playlist in your Spotify account
...
5. The app creates or updates a _Moodfade_ playlist in your Spotify account.
